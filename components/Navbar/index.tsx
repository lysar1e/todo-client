...
export const Navbar: React.FC<Props> = observer(({ isLogin }) => {
  ...
  return (
    <nav className={theme.theme} data-testid="nav">
      ...
      >
        <Link href="/">
          <a className="brand-logo" data-testid="brand">
            MERN Todo App
          </a>
        </Link>
        {isLogin ? (
          <>
            ...
            <div
              className={`mobile-modal ${theme.theme} ${
                clicked ? "show-modal" : ""
              }`}
            >
              <div className="mobile-modal__content">
                <span
                  className={`mobile-modal__close ${theme.theme}`}
                ...
                <div className="switch">
                  <label>
                    <span className={`mobile-text switch-text ${theme.theme}`}>
                      Light theme
                    </span>
                    <input
                      type="checkbox"
                ...
                <Link href="/">
                  <a onClick={() => logout()} className={`quit ${theme.theme}`}>
                    Выйти
                  </a>
                </Link>
              </div>
