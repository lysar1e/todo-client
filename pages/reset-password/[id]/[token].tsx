...
const ResetPassword: NextPage<{ expired?: boolean; email?: string }> = observer(
  ({ expired, email }) => {
    ...
    if (expired) {
      return <h1 className={theme.theme}>Link has been expired</h1>;
    }
      ...
      <>
        ...
        <div className="container">
          ...
          <form onSubmit={(e) => e.preventDefault()}>
            ...
            />
            <button
              className={`btn ${theme.theme} get-link`}
              disabled={
                !firstPassword ||
                !secondPassword ||
